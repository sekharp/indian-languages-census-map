...
class App extends Component {
  ...
  chooseLanguage = selectedLanguage => {
    ...
    if (includes(["hindi", "gujarati", "urdu"], selectedLanguage)) {
      url =
        `https://api.census.gov/data/2013/language?get=EST,LAN,LANLABEL,NAME&for=US` +
    ...
    return Promise.resolve(promise).then(result => {
      ...
      this.setState({
        nationwideSpeakers: nationwideSpeakers,
    ...
    return (
      <div className="App" style={{ fontFamily: "Verdana" }}>
        ...
        <div className="info legend">
          ...
          <br />
          <div>
            <i style={{ backgroundColor: "#FFEDA0" }} />
            <br />0-100
          </div>
          <div>
            <i style={{ backgroundColor: "#FED976" }} />
            <br />100-500
          </div>
          <div>
            <i style={{ backgroundColor: "#FEB24C" }} />
            <br />500-1000
          </div>
          <div>
            <i style={{ backgroundColor: "#FD8D3C" }} />
            <br />1000-5000
          </div>
          <div>
            <i style={{ backgroundColor: "#FC4E2A" }} />
            <br />5000-10000
          </div>
          <div>
            <i style={{ backgroundColor: "#E31A1C" }} />
            <br />10000-20000
          </div>
          <div>
            <i style={{ backgroundColor: "#BD0026" }} />
            <br />20000-35000
          </div>
          <div>
            <i style={{ backgroundColor: "#800026" }} />
            <br />35000+
          </div>
          <br />
          N/A - Unavailable, likely due to small size (anonymized), or zero
          speakers.<br />
          <b>
            Data From 2009-13, US Census American Community Survey. 3,441,773
            South Asian Americans Nationwide (2010 Census).
          </b>
          <br />
        </div>
        <div>
